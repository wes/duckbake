...
export function DataVisualization({ result, config, description, sql }: DataVisualizationProps) {
        ...
        <thead className="sticky top-0 bg-muted">
          <tr>
            {result.columns.map((col) => (
              <th key={col} className="border border-border px-3 py-2 text-left font-medium">
                {col}
              </th>
            ))}
          </tr>
